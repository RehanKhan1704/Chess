...
public class CheckScanner {
        ...
        private boolean hitByKnight(int col,int row,Piece king,int kingCol,int kingRow){
            return checkedKnight(board.getPiece(kingCol-1,kingRow-2),king,col,row) ||
                    checkedKnight(board.getPiece(kingCol+1,kingRow-2),king,col,row) ||
                            checkedKnight(board.getPiece(kingCol+2,kingRow-1),king,col,row) ||
                                    checkedKnight(board.getPiece(kingCol+2,kingRow+1),king,col,row) ||
                                            checkedKnight(board.getPiece(kingCol+1,kingRow+2),king,col,row) ||
                                                    checkedKnight(board.getPiece(kingCol-1,kingRow+2),king,col,row) ||
                                                            checkedKnight(board.getPiece(kingCol-2,kingRow+1),king,col,row) ||
        ...
        private boolean checkedKnight(Piece p,Piece k,int col,int row){
        ...
        private boolean hitByPawn(int col,int row,Piece king,int kingCol,int kingRow){
            ...
            return checkedPawn(board.getPiece(kingCol+1,kingRow+colorVal),king,col,row) ||
                    checkedPawn(board.getPiece(kingCol-1,kingRow+colorVal),king,col,row);
        }
        private boolean checkedPawn(Piece p,Piece k,int col,int row){
